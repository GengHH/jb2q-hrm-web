        ...
        <el-row>
          ...
          <el-col class="ul-style" :span="12">
            ...
            <p class="six-hui  line30 mat-15">
              {{ activityItem.apply }}
              <el-button
                class="release-btn font-size18"
                type="primary"
                @click="applyActivity(activityItem)"
                v-if="activityItem.apply === '0' && !hadApply"
                ><i class="icon iconfont font-size20">&#xe653;</i>
                去报名</el-button
              >
              <el-button class="release-btn font-size18" type="primary" v-else
                ><i class="icon iconfont font-size20">&#xe653;</i>
                已报名</el-button
              >
            </p>
...
export default {
  ...
  methods: {
    ...
    async loadActDetailsInfo() {
      let queryRes = await queryPersonSpecialActivityDetail({
