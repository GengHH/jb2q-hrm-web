 ...
 * @LastEditTime: 2021-04-01 15:48:47
...
const unit_query_agency = (params, fn, fnErr) =>
  getAction(urlStr + 'position/query', params, fn, fnErr);
...
const unit_edit = (params, fn, fnErr) =>
  getAction(urlStr + 'position/resume/modify', params, fn, fnErr);
...
const management_edit = (params, fn, fnErr) =>
  getAction(urlStr + 'modify', params, fn, fnErr);
