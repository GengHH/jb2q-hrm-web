...
//获取管理员推荐职位信息(分页)
Mock.mock(
  RegExp(basePath + '/person/recommend/queryRecommendList' + '.*'),
  'post',
  function(options) {
    return {
      status: 200,
          ...
          'data|1-10': [
            {
              recId: '45',
              recType: '2',
              targetId: '201608111877450',
              recObj: '1',
              userId: '0001564698',
              recTime: '2021-05-29 12:31:43',
              viewPosition: '1',
              viewTime: '2021-05-29 12:56:02',
              deliveryResume: '',
              applyforId: '',
              positionId: '1',
...
Mock.mock(basePath + '/person/recommend/doApplyFor', 'post', function(options) {
  return successData;
});
Mock.mock(
  basePath + '/person/recommend/doQueryRecommendDetail',
  'post',
  function(options) {
    return {
      status: 200,
          ...
          data: [
            {
              ...
              actEndTime: '2021-05-31 00:00:00',
              actAddress: '测试123',
              content:
                '测测123sdfasdfasdfasdjsdh第三方国际湿地几点睡佛感受到【 防守打法屁股上店铺发个视频电饭锅极速拍档测测123sdfasdfasdfasdjsdh第三方国际湿地几点睡佛感受到【 防守打法屁股上店铺发个视频电饭锅极速拍档测测123sdfasdfasdfasdjsdh第三方国际湿地几点睡佛感受到【 防守打法屁股上店铺发个视频电饭锅极速拍档',
              release: '1',
              applyStartTime: '2021-05-01 00:00:00',
              applyEndTime: '2021-05-31 00:00:00',
              selfApplyMax: '100',
              recApplyMax: '100',
              propagandaImage:
                '',
              relTime: '2021-05-26 09:59:47',
              userId: '0001564698',
              actSituation: '',
              participants: '',
              attendCount: '',
...
//特色活动-详情信息
Mock.mock(
  RegExp(basePath + '/person/activity/queryPersonSpecialActivityDetail'),
  'post',
  function(options) {
    return {
      status: 200,
